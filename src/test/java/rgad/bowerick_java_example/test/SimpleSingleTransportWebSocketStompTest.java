 ...
 * Stomp via WebSockets, from within Java.
 * 
 * @author Ruediger Gad &lt;r.c.g@gmx.de&gt;
 *
 */
public class SimpleSingleTransportWebSocketStompTest {

	private static final String STOMP_TRANSPORT_URL = "ws://127.0.0.1:1701";
